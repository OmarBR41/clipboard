...
import ImgGoogle from '../../images/logos/logo-google.png'
import ImgIBM from '../../images/logos/logo-ibm.png'
import ImgMicrosoft from '../../images/logos/logo-microsoft.png'
import ImgHP from '../../images/logos/logo-hp.png'
import ImgVG from '../../images/logos/logo-vector-graphics.png'
    ...
    <div className="workflow-section">
      ...
      <div className="workflow-tools">
        <div className="workflow-tool">
          ...
          <h3 className="workflow-subtitle">Create blacklists</h3>
          <p className="workflow-text">Ensure sensitive information never makes its way to your clipboard by excluding certain sources.</p>
        </div>
        <div className="workflow-tool">
          <div className="workflow-icon">
          ...
          <h3 className="workflow-subtitle">Plain text snippets</h3>
          <p className="workflow-text">Remove unwanted formatting from copied text for a consistent look.</p>
        </div>
        <div className="workflow-tool">
          <div className="workflow-icon">
          ...
          <h3 className="workflow-subtitle">Sneak preview</h3>
          <p className="workflow-text">Quick preview of all snippets on your Clipboard for easy access.</p>
        </div>
      </div>

      <div className="workflow-logos">
        <img className="workflow-logo" src={ImgGoogle} alt="Logo of Google"/>
        <img className="workflow-logo" src={ImgIBM} alt="Logo of IBM"/>
        <img className="workflow-logo" src={ImgMicrosoft} alt="Logo of Microsoft"/>
        <img className="workflow-logo" src={ImgHP} alt="Logo of HP"/>
        <img className="workflow-logo" src={ImgVG} alt="Logo of Vector Graphics"/>
      </div>
    </div>
  )
}
